...
class VerifyLogging extends StatefulWidget {
  const VerifyLogging({Key? key}) : super(key: key);

  @override
  _VerifyLoggingState createState() => _VerifyLoggingState();
}

class _VerifyLoggingState extends State<VerifyLogging> {
  ...
  Future sendVerificationEmail() async{
    var snack2 = SnackBar(
      ...
      backgroundColor: Color(0xfffa4e4e),
    );
